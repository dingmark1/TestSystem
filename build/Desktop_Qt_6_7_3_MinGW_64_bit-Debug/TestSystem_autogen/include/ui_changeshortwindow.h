/********************************************************************************
** Form generated from reading UI file 'changeshortwindow.ui'
**
...
#ifndef UI_CHANGESHORTWINDOW_H
#define UI_CHANGESHORTWINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *ChangeShortWindow)
    {
        if (ChangeShortWindow->objectName().isEmpty())
            ChangeShortWindow->setObjectName("ChangeShortWindow");
        ChangeShortWindow->resize(800, 600);
        centralwidget = new QWidget(ChangeShortWindow);
        ...
        ChangeShortWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(ChangeShortWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 28));
        ChangeShortWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(ChangeShortWindow);
        statusbar->setObjectName("statusbar");
        ChangeShortWindow->setStatusBar(statusbar);

        retranslateUi(ChangeShortWindow);

        QMetaObject::connectSlotsByName(ChangeShortWindow);
    } // setupUi
    ...
    void retranslateUi(QMainWindow *ChangeShortWindow)
    {
        ...
        label_3->setText(QCoreApplication::translate("ChangeShortWindow", "\347\247\221\347\233\256\357\274\232", nullptr));
        upload_pushButton->setText(QCoreApplication::translate("ChangeShortWindow", "\344\270\212\344\274\240", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ChangeShortWindow: public Ui_ChangeShortWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHANGESHORTWINDOW_H
