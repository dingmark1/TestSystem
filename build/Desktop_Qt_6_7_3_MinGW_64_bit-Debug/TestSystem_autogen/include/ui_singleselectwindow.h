/********************************************************************************
** Form generated from reading UI file 'singleselectwindow.ui'
**
...
#ifndef UI_SINGLESELECTWINDOW_H
#define UI_SINGLESELECTWINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *SingleSelectWindow)
    {
        if (SingleSelectWindow->objectName().isEmpty())
            SingleSelectWindow->setObjectName("SingleSelectWindow");
        SingleSelectWindow->resize(800, 600);
        centralwidget = new QWidget(SingleSelectWindow);
        ...
        SingleSelectWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(SingleSelectWindow);
        statusbar->setObjectName("statusbar");
        SingleSelectWindow->setStatusBar(statusbar);

        retranslateUi(SingleSelectWindow);

        QMetaObject::connectSlotsByName(SingleSelectWindow);
    } // setupUi
    ...
    void retranslateUi(QMainWindow *SingleSelectWindow)
    {
        ...
        label_4->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\344\270\211", nullptr));
        label_5->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\345\233\233", nullptr));
        label_6->setText(QCoreApplication::translate("SingleSelectWindow", "\347\255\224\346\241\210\357\274\232", nullptr));
        option1_radioButton->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\344\270\200", nullptr));
        option2_radioButton_2->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\344\272\214", nullptr));
        option3_radioButton_3->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\344\270\211", nullptr));
        option4_radioButton_4->setText(QCoreApplication::translate("SingleSelectWindow", "\351\200\211\351\241\271\345\233\233", nullptr));
        label_8->setText(QCoreApplication::translate("SingleSelectWindow", "\347\247\221\347\233\256\357\274\232", nullptr));
        upload_pushButton->setText(QCoreApplication::translate("SingleSelectWindow", "\344\270\212\344\274\240", nullptr));
    } // retranslateUi

};

namespace Ui {
    class SingleSelectWindow: public Ui_SingleSelectWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SINGLESELECTWINDOW_H
